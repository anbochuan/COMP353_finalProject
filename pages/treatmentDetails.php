...
<html>
<head>
<title>Treatment Price - BSPC</title>
	...
	<main class="hoc container clear">
        ...
        **************** -->
		...
		<div class="sectiontitle">
		      <h3 class="heading">Treatment Price Report</h3>
		...
		<div class="pageContent">
            ...
            **************** -->
             ...
             <div class = "formGroup">
                <p>The following report shows the differnet kinds of treatments that the prices between  
            ...
            if (isset($_POST['submit']) )
            {
                ...
                {
                    $query1 = " SELECT Treatment_Name, Price 
                            FROM treatment 
...
echo("  <div class=\"invoice-box\">
        <table cellpadding=\"0\" cellspacing=\"0\">
            ...
            <tr class=\"heading\">
                <td colspan=\"3\">
                    All available treatments which are under the given price range are:  <br/>     
                </td>
            </tr>
       ...
       echo("<tr class=\"item\">
            ...
            echo("<tr class=\"heading\">
                <td colspan=\"3\">
                    There are $count different kinds of treatments that under the given price range.</br>
                </td>
            </tr>
        </table>
    </div>");
